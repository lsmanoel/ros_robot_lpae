...
int main(int argc, char** argv)
{
    ...
    video_L_capture.set(1, FULL_FRAME_WIDTH);
    video_L_capture.set(2, FULL_FRAME_HEIGHT);
    video_R_capture.set(1, FULL_FRAME_WIDTH);
    video_R_capture.set(2, FULL_FRAME_HEIGHT);
